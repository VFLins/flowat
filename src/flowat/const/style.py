...
CONTENT_WIDTH = 510
FORM_WIDTH = 395 if platform == "linux" else 270
...
HEADING2 = Pack(
    font_size=11, font_weight="bold", font_style="italic", margin=(10, 0, 0, 0)
)
...
if platform == "win32":
    ...
    RIGHTMOST_SIMPLE_BUTTON = Pack(width=90, margin=(0, 0, 0, 5))
    SIMPLE_SMALL_BUTTON = Pack(height=28, font_size=9, margin=5)
    RIGHTMOST_SIMPLE_SMALL_BUTTON = Pack(height=28, font_size=9, margin=(5, 0, 5, 5))
